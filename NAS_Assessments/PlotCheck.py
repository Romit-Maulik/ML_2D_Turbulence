...
eplot_ml = np.load('Spectra_Switch.npy')[1]
eplot_iles = np.load('Spectra_ILES.npy')[1]
...
plt.loglog(kplot_udns,eplot_ml,label='ML',color='orange')
plt.loglog(kplot_udns,eplot_iles,label='ILES',color='green')
...
field = np.load('Field_Switch.npy')
